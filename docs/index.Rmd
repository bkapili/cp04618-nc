...
pHeat
```
**Figure 2:** Heat map showing relative abundance of microbes in each sample (N = 209 total identified). Each row corresponds to a unique microbe and each column corresponds to an individual sample. Note the relative abundance colorscale is in log units.
...
* *Streptococcus anginosus*:
  ...
  * Most relatively abundant microbe in proximal CapScan sample (~8%)
<br><br>
